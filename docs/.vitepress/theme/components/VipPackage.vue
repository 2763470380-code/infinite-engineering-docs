...
const packages = {
  'black-iron': {
    ...
    categories: [
      { name: '重要物品', items: [{ name: '基础AE存储' }, { name: '基础工业升级模组机器与发电设备' }, { name: 'MEK模组机器与发电设备' }] },
  ...
  bronze: {
    ...
    categories: [
      { name: '重要物品', description: '四倍加速，加速产线与机器，节约大量时间。分子重构仪：加工精华。', items: [{ name: '加速火把' }, { name: '高级AE存储' }, { name: '高级工业升级模组机器与发电设备' }, { name: '高级MEK模组机器与发电设备' }, { name: '分子重构仪' }] },
  ...
  gold: {
    ...
    categories: [
      { name: '重要', description: '四倍加速，加速产线与机器，节约大量时间。复制机四件套：消耗 UU 物质复制物品。QE/EF 能源转换器：QE 能源与 EF 相互转换。万魂之核：终焉工作台核心物品。', items: [{ name: '加速火把' }, { name: '高级AE自动化设备' }, { name: '更高级AE存储' }, { name: '更高级工业升级模组机器与发电设备' }, { name: '更高级MEK模组机器与发电设备' }, { name: '量子能源设备' }, { name: '复制机四件套' }, { name: 'QE/EF能源转换器' }, { name: '万魂之核' }] },
  ...
  diamond: {
    ...
    categories: [
      { name: '重要', description: '压缩加速火把：360 倍加速，极致加速，效率爆表。复制机四件套：无限 UU。QE/EF 能源转换器：QE 能源与 EF 相互转换。', items: [{ name: '压缩加速火把' }, { name: '顶级AE自动化设备' }, { name: '无限AE存储' }, { name: '顶级工业升级模组机器与发电设备' }, { name: '顶级MEK模组机器' }, { name: '无限FE能源' }, { name: '高级量子能源设备' }, { name: '复制机四件套' }, { name: 'QE/EF能源转换器' }, { name: '终焉工作台' }, { name: '量子变换器' }, { name: '创造魔力池' }] },
  ...
  infinity: {
    ...
    categories: [
      { name: '重要', description: '压缩加速火把：360 倍加速，极致加速，效率爆表。时序钟：至高 256 倍加速机器与作物。区块加载器：离线加载，无需挂机。永恒奇点与无尽催化剂：无尽材料。无限元件：矿石：无限全种类矿石，世上存在的矿石种类“all infinite”。复制机四件套：无限 UU。QE/EF 能源转换器：QE 能源与 EF 相互转换。创造流体储罐：可选任意流体无限。创造化学品储罐：可选任意气体无限。', items: [{ name: '压缩加速火把', quantity: '2' }, { name: '时序钟' }, { name: '区块加载器' }, { name: '永恒奇点', quantity: '8' }, { name: '无尽催化剂', quantity: '4' }, { name: '无限元件：矿石' }, { name: '终极AE自动化设备' }, { name: '无限AE存储' }, { name: '终极工业升级模组机器与发电设备' }, { name: '终极MEK模组机器' }, { name: '无限FE能源' }, { name: '高级量子能源设备' }, { name: '复制机四件套' }, { name: 'QE/EF能源转换器' }, { name: '终焉工作台' }, { name: '量子变换器' }, { name: '创造魔力池' }, { name: '固态UU复制机' }, { name: '创造流体储罐' }, { name: '创造化学品储罐' }] },
